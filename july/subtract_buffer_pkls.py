...
WT_integrated = [-1*sum(WT_subtracted[i][1][2:17])*.0025 for i in range(1,len(times_numeric))]
...
Mut_integrated = [-1*sum(Mut_subtracted[i][1][3:17])*.0025 for i in range(1,len(times_numeric))]
