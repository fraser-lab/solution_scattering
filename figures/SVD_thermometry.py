...
STATIC_REPS = [range(38,48), range(38,48), range(38,48)]
STATIC_TEMPS = ["14", "21", "28"]
REPS = range(11, 13)
# PREFIX = "CypA-6"
# PREFIX = "CypA-5"
PREFIX = "CypA-S99T-Buffer-2"
STATIC_PREFIX = "CypA-S99T-static-2_offBT"
	...
	for temp in TEMPS:
		for index, time in enumerate(TIMES):
			try: 
				...
				print "{0}/{1}_{2}_{3}_{4}_off.tpkl".format(tr_directory, PREFIX, temp, i+1, time)
