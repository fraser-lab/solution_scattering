...
#     recip_T_1_list (or recip_T_2_list) is a list of reciprocal temperatures (1/T) in units of 1/K 
#     k1_list (or k2_list) is a list of rates in units of 1/s, calculated from a kinetic analysis
#     k1_err_list (or k2_err_list) is a list of the errors calculated for the rates in k1_list (or k2_list), also in units of 1/s
#     **Note that a rate, its error, and the associated inverse temperature must all have the same index within their respective lists
#     filename is a variable specifying the output file name for the png image of the Eyring plot
#
# You may also want to change some of the plot settings, particularly plt.xlim and plt.ylim
#
...
plt.xlim(3.28, 3.62) # change to accomodate your data
plt.ylim(3.0, 9.0) # change to accomodate your data
